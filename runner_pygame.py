...
snail_frame1=pygame.image.load("graphics/snail/snail1.png").convert_alpha() # will not show other white spaces
snail_frame2=pygame.image.load("graphics/snail/snail2.png").convert_alpha() # will not show other white spaces
    ...
    for event in pygame.event.get():
        ...
        if game_active:
            if event.type==pygame.MOUSEBUTTONDOWN:
                if player_rect.collidepoint(event.pos) and player_rect.boot>=300:
                    jump_sound.play()
                    player_gravity=-20
